...
ifneq ($(OS_CURRENT),$(OS_ORIGINAL))
	...
	${MAKE}  -f nbproject/Makefile-pic32-Ethernet-starter-kit.mk dist/${CND_CONF}/${IMAGE_TYPE}/arduino-booloader.X.${IMAGE_TYPE}.elf
...
# Clean Targets
.clean-conf:
	${RM} -r build/pic32-Ethernet-starter-kit
	${RM} -r dist
