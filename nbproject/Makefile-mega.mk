...
ifneq ($(OS_CURRENT),$(OS_ORIGINAL))
	...
	${MAKE}  -f nbproject/Makefile-mega.mk dist/${CND_CONF}/${IMAGE_TYPE}/arduino-booloader.X.${IMAGE_TYPE}.elf
...
${OBJECTDIR}/pic32bootloader.o: pic32bootloader.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -x c -c -mprocessor=32MX795F512L -ffunction-sections -fdata-sections -mips16 -D_BOARD_DIGILENT_MEGA_ -Os -MMD -MF ${OBJECTDIR}/pic32bootloader.o.d -o ${OBJECTDIR}/pic32bootloader.o pic32bootloader.c 
...
${OBJECTDIR}/pic32bootloader.o: pic32bootloader.c  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR} 
	${RM} ${OBJECTDIR}/pic32bootloader.o.d 
	${MP_CC}  -x c -c -mprocessor=32MX795F512L -ffunction-sections -fdata-sections -mips16 -D_BOARD_DIGILENT_MEGA_ -Os -MMD -MF ${OBJECTDIR}/pic32bootloader.o.d -o ${OBJECTDIR}/pic32bootloader.o pic32bootloader.c 
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	 sed -e 's/\\$$/__EOL__/g' -e 's/\\ /__ESCAPED_SPACES__/g' -e 's/\\/\//g' -e 's/__ESCAPED_SPACES__/\\ /g' -e 's/__EOL__$$/\\/g' ${OBJECTDIR}/pic32bootloader.o.d > ${OBJECTDIR}/pic32bootloader.o.tmp
	${RM} ${OBJECTDIR}/pic32bootloader.o.d 
	${CP} ${OBJECTDIR}/pic32bootloader.o.tmp ${OBJECTDIR}/pic32bootloader.o.d 
