...
ifneq ($(OS_CURRENT),$(OS_ORIGINAL))
	...
	${MAKE}  -f nbproject/Makefile-Digilent-Cerebot-32MX4.mk dist/${CND_CONF}/${IMAGE_TYPE}/arduino-booloader.X.${IMAGE_TYPE}.elf
...
${OBJECTDIR}/startup.o: startup.S  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR} 
	${MP_CC}  -D__DEBUG  -D__MPLAB_DEBUGGER_PIC32MXSK=1 -c -mprocessor=32MX460F512L  -o ${OBJECTDIR}/startup.o startup.S  -Wa,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__ICD2RAM=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PIC32MXSK=1,--gdwarf-2
else
.PHONY: ${OBJECTDIR}/startup.o
${OBJECTDIR}/startup.o: startup.S  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR} 
...
${OBJECTDIR}/pic32bootloader.o: pic32bootloader.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -x c -c -mprocessor=32MX460F512L -ffunction-sections -fdata-sections -mips16 -D_BOARD_MIKROE_MULTIMEDIA_ -Os -MMD -MF ${OBJECTDIR}/pic32bootloader.o.d -o ${OBJECTDIR}/pic32bootloader.o pic32bootloader.c 
...
# Clean Targets
.clean-conf:
	${RM} -r build/Digilent-Cerebot-32MX4
	${RM} -r dist
