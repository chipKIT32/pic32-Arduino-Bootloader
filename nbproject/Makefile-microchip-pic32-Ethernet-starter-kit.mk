...
CP=cp 
# Macros
CND_CONF=microchip-pic32-Ethernet-starter-kit
...
ifneq ($(OS_CURRENT),$(OS_ORIGINAL))
	...
	${MAKE}  -f nbproject/Makefile-microchip-pic32-Ethernet-starter-kit.mk dist/${CND_CONF}/${IMAGE_TYPE}/arduino-booloader.X.${IMAGE_TYPE}.elf
...
${OBJECTDIR}/startup.o: startup.S  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR} 
	${MP_CC}  -D__DEBUG  -D__MPLAB_DEBUGGER_ICD3=1 -c -mprocessor=32MX795F512L  -o ${OBJECTDIR}/startup.o startup.S  -Wa,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__ICD2RAM=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1,--gdwarf-2
else
.PHONY: ${OBJECTDIR}/startup.o
${OBJECTDIR}/startup.o: startup.S  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR} 
	${MP_CC}  -c -mprocessor=32MX795F512L  -o ${OBJECTDIR}/startup.o startup.S  -Wa,--defsym=__MPLAB_BUILD=1
endif
...
${OBJECTDIR}/pic32bootloader.o: pic32bootloader.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -x c -c -mprocessor=32MX795F512L -ffunction-sections -fdata-sections -mips16 -D_BOARD_ETHERNET_STARTER_KIT_ -Os -MMD -MF ${OBJECTDIR}/pic32bootloader.o.d -o ${OBJECTDIR}/pic32bootloader.o pic32bootloader.c 
...
${OBJECTDIR}/pic32bootloader.o: pic32bootloader.c  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR} 
	${RM} ${OBJECTDIR}/pic32bootloader.o.d 
	${MP_CC}  -x c -c -mprocessor=32MX795F512L -ffunction-sections -fdata-sections -mips16 -D_BOARD_ETHERNET_STARTER_KIT_ -Os -MMD -MF ${OBJECTDIR}/pic32bootloader.o.d -o ${OBJECTDIR}/pic32bootloader.o pic32bootloader.c 
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	 sed -e 's/\\$$/__EOL__/g' -e 's/\\ /__ESCAPED_SPACES__/g' -e 's/\\/\//g' -e 's/__ESCAPED_SPACES__/\\ /g' -e 's/__EOL__$$/\\/g' ${OBJECTDIR}/pic32bootloader.o.d > ${OBJECTDIR}/pic32bootloader.o.tmp
	${RM} ${OBJECTDIR}/pic32bootloader.o.d 
	${CP} ${OBJECTDIR}/pic32bootloader.o.tmp ${OBJECTDIR}/pic32bootloader.o.d 
...
dist/${CND_CONF}/${IMAGE_TYPE}/arduino-booloader.X.${IMAGE_TYPE}.elf: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC}  -mdebugger -D__MPLAB_DEBUGGER_ICD3=1 -mprocessor=32MX795F512L -nostartfiles -o dist/${CND_CONF}/${IMAGE_TYPE}/arduino-booloader.X.${IMAGE_TYPE}.elf ${OBJECTFILES}      -Wl,--defsym=__MPLAB_BUILD=1,--script=boot-linkerscript.ld,--defsym=__MPLAB_DEBUG=1,--defsym=__ICD2RAM=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1,--gc-sections,-Map="map.txt",--cref,-Os
else
dist/${CND_CONF}/${IMAGE_TYPE}/arduino-booloader.X.${IMAGE_TYPE}.elf: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC}  -mprocessor=32MX795F512L -nostartfiles -o dist/${CND_CONF}/${IMAGE_TYPE}/arduino-booloader.X.${IMAGE_TYPE}.elf ${OBJECTFILES}      -Wl,--defsym=__MPLAB_BUILD=1,--script=boot-linkerscript.ld,--gc-sections,-Map="map.txt",--cref,-Os
...
# Clean Targets
.clean-conf:
	${RM} -r build/microchip-pic32-Ethernet-starter-kit
	${RM} -r dist
