...
//************************************************************************
static void 	Serial_print(char *textString)
{
#if 0
	while (*textString != 0)
	{
		Serial_write(*textString);
		textString++;
	}
#else
char	theChar;
...
//************************************************************************
static void 	Serial_PrintLongWordHex(uint32_t longWord)
{
...
//unsigned long	gCurrentPageNumber;
//--int				gBytesInFlashBuffer;
...
//*****************************************************************************
static void DebugTimeOut(void)
{
int ii;

	Serial_println();
	Serial_print("debugging timeouts");
	Serial_println();
...
//	delay_ms(100);
	...
	//+						boot_spm_busy_wait();
				...
				//--		if (gBytesInFlashBuffer > 0)
				//--		{
				//--			boot_page_write(gCurrentPageNumber);
				//--		}
...
#define	PROGMEM
	...
	prog_char	gTextMsg_Explorer[]			PROGMEM	=	"Explorer stk500V2 by MLS";
